...
export default function Row(props) {
    const rankingPoster = [
        ...
        <svg id="rank-2" width="100%" height="100%" viewBox="0 0 80 154" className="svg-icon svg-icon-rank-2 top-10-rank">
            <path
                stroke="#595959"
        ...
        <svg id="rank-3" width="100%" height="100%" viewBox="0 0 80 154" className="svg-icon svg-icon-rank-3 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
        ...
        <svg id="rank-4" width="100%" height="100%" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-4 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
        ...
        <svg id="rank-5" width="100%" height="100%" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-5 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
        ...
        <svg id="rank-6" width="100%" height="100%" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-6 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
        ...
        <svg id="rank-7" viewBox="0 0 78 154" width="100%" height="100%" className="svg-icon svg-icon-rank-7 top-10-rank">
            <path stroke="#595959" strokeWidth="4" d="M113,2 L2,2 L2,33.4022989 L75.9665929,33.4022989 L21.22571,152 L60.28102,152 L113,32.7672283 L113,2 Z" strokeLinejoin="square"></path>
        </svg>,
        <svg id="rank-8" width="100%" height="100%" viewBox="0 0 77 154" className="svg-icon svg-icon-rank-8 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
        ...
        <svg id="rank-9" viewBox="0 0 71 154" width="100%" height="100%" className="svg-icon svg-icon-rank-9 top-10-rank">
            <path
                stroke="#595959"
                strokeWidth="4"
        ...
        <svg id="rank-10" width="100%" height="100%" viewBox="0 0 140 154" className="svg-icon svg-icon-rank-10 top-10-rank">
            <path
                stroke="#595959"
                strokeLinejoin="square"
                strokeWidth="4"
                        ...
                        <div key={index}>
                            {index <= 9 ? (
                                item.poster_path !== null ? (
                                    <>
                                        <SwiperSlide key={index} virtualIndex={index} className="row-image-poster">
                                            <Movie show={props.show} item={item} type={props.type} rank={rankingPoster[index]} />
                                        </SwiperSlide>
                                    </>
                                ) : (
                                    " "
